                ...
                <div className='about__experience__accordeon'>
                    ...
                    >
                        <>
                            ...
                            <p>
                                ...
                                résolution des bugs, optimisation UX/UI, prise
                                en charge des demandes clients.
                            </p>
                            <p>
                                Chef de Projet Graphisme et Développement :
                                gestion de l’équipe de graphistes, développeurs
                                et webmasters. Étude des nouveux cahiers des
                                charges, gestion des plannings et des litiges
                                clients, étude et devis sur les développements
                                spécifiques, contrôle final des sites avant mise
                                en ligne.
                            </p>
                        </>
                    </Accordion>
                    ...
                    <Accordion title='Road 2 Race' image={R2R}>
                        <>
                            ...
                            <p>
                                ...
                                e-commerce dans l’univers de la moto. Gestion
                                via le CMS Magento, création de fiches produits
                                et artworks, design graphique du site,
                    ...
                    <Accordion title='Graph & Co' image={GraphAndCo}>
                        <>
                            ...
                            <p>
                                ...
                                supports visuels (logos, chartes graphiques),
                                retouches photographiques et campagnes
                                webmarketing.
                            </p>
                        </>
                    </Accordion>
                    ...
                    <Accordion title='Creawebdesign' image={Creawebdesign}>
                        <>
                            ...
                            <p>
                                ...
                                supports de communication, aide à la réalisation
                                de sites web vitrines et marchands.
                            </p>
                        </>
                    </Accordion>
                    ...
                    <Accordion title='Alsamanutention' image={Alsamanutention}>
                        <>
                            ...
                            <p>
                                Responsable communication et informatique, mise
                                en place de nouveaux outils de communication :
                                refonte du site web, documentation interne et
                                supports destinés aux techniciens.
                            </p>
                        </>
                    </Accordion>
                </div>
